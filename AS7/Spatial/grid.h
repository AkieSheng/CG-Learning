...
struct Grid : Object3D {
  ...
  auto getInfiniteObjects() const -> Object3DVector const& { return *infiniteObjects; }
  ...
  auto voxelIndexRange(Vec3f const& wmin, Vec3f const& wmax, int& i0, int& i1,
                       int& j0, int& j1, int& k0, int& k1) const -> void;
